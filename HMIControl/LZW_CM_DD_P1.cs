...
{
    [DD]
    public class LZW_CM_DD_P1 : HMIControlBase
    {
        static LZW_CM_DD_P1()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(LZW_CM_DD_P1), new FrameworkPropertyMetadata(typeof(LZW_CM_DD_P1)));
        }

        public static DependencyProperty STAProperty = DependencyProperty.Register("STA", typeof(short), typeof(LZW_CM_DD_P1));
        public static DependencyProperty MDProperty = DependencyProperty.Register("MD", typeof(short), typeof(LZW_CM_DD_P1));
        public static DependencyProperty ModeVisibleProperty = DependencyProperty.Register("ModeVisible", typeof(bool), typeof(LZW_CM_DD_P1));
        public static DependencyProperty BorderVisibleProperty = DependencyProperty.Register("BorderVisible", typeof(bool), typeof(LZW_CM_DD_P1));
        public static DependencyProperty ActivedProperty = DependencyProperty.Register("CM_DD_Actived", typeof(bool), typeof(LZW_CM_DD_P1));
        public static DependencyProperty TypeProperty = DependencyProperty.Register("std_Type_ValveNC", typeof(bool), typeof(LZW_CM_DD_P1));
        public static DependencyProperty AlarmBlinkProperty = DependencyProperty.Register("AlarmBlink", typeof(bool), typeof(LZW_CM_DD_P1));
        ...
        public override LinkPosition[] GetLinkPositions()
        {
            return new LinkPosition[2]
                {
                    new  LinkPosition(new Point(0.1,0.5),ConnectOrientation.Left),
                    new  LinkPosition(new Point(0.9,0.5),ConnectOrientation.Right),
                };
        }
